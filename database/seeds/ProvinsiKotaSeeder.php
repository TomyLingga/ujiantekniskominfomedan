...
class ProvinsiKotaSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $tes ="";   //tempat tampung data
        $q = 0;     //untuk id setiap provinsi
        $d = array_keys($data);     //menghitung banyaknya keys (provinsi)
        foreach ($d as $key) {      //keys berupa nama provinsi
            $q++;
            //contoh: $data[$key] adalah $data["Aceh"]
            foreach ($data[$key] as $k) {
                DB::table('prov_kota')->insert([
                    [
                        'id_prov' => $q,
                        'nama_prov' => $key,
                        'nama_kota' => $k
